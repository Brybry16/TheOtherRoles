...
namespace BetterOtherRoles.Objects {
    ...
    public class Portal {
        ...
        public static void startTeleport(byte playerId, byte exit) {
            ...
            string playerNameDisplay = BetterOtherRoles.Portalmaker.logOnlyHasColors ? "A player (" + (Helpers.isLighterColor(playerControl) ? "L" : "D") + ")" : playerControl.Data.PlayerName;
