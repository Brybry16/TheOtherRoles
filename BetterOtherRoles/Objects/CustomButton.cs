    ...
    public class CustomButton {
        ...
        public void onClickEvent()
        {
            if (this.Timer < 0f && HasButton() && CouldUse())
            {
                ...
                if (BetterOtherRoles.Deputy.handcuffedKnows.ContainsKey(CachedPlayer.LocalPlayer.PlayerId) && BetterOtherRoles.Deputy.handcuffedKnows[CachedPlayer.LocalPlayer.PlayerId] > 0f) return;
        ...
        public void Update()
        {
            ...
            if (BetterOtherRoles.Deputy.handcuffedPlayers.Contains(localPlayer.PlayerId)) {
                OnClick = () => {
