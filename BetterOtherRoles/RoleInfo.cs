...
namespace BetterOtherRoles
{
    public class RoleInfo {
        ...
        public static RoleInfo jester = new RoleInfo("Jester", BetterOtherRoles.Jester.color, "Get voted out", "Get voted out", RoleId.Jester, true);
        public static RoleInfo mayor = new RoleInfo("Mayor", BetterOtherRoles.Mayor.color, "Your vote counts twice", "Your vote counts twice", RoleId.Mayor);
        public static RoleInfo portalmaker = new RoleInfo("Portalmaker", BetterOtherRoles.Portalmaker.color, "You can create portals", "You can create portals", RoleId.Portalmaker);
        public static RoleInfo engineer = new RoleInfo("Engineer",  BetterOtherRoles.Engineer.color, "Maintain important systems on the ship", "Repair the ship", RoleId.Engineer);
        public static RoleInfo sheriff = new RoleInfo("Sheriff", BetterOtherRoles.Sheriff.color, "Shoot the <color=#FF1919FF>Impostors</color>", "Shoot the Impostors", RoleId.Sheriff);
        public static RoleInfo deputy = new RoleInfo("Deputy", BetterOtherRoles.Sheriff.color, "Handcuff the <color=#FF1919FF>Impostors</color>", "Handcuff the Impostors", RoleId.Deputy);
        public static RoleInfo lighter = new RoleInfo("Lighter", BetterOtherRoles.Lighter.color, "Your light never goes out", "Your light never goes out", RoleId.Lighter);
        public static RoleInfo godfather = new RoleInfo("Godfather", BetterOtherRoles.Godfather.color, "Kill all Crewmates", "Kill all Crewmates", RoleId.Godfather);
        public static RoleInfo mafioso = new RoleInfo("Mafioso", BetterOtherRoles.Mafioso.color, "Work with the <color=#FF1919FF>Mafia</color> to kill the Crewmates", "Kill all Crewmates", RoleId.Mafioso);
        public static RoleInfo janitor = new RoleInfo("Janitor", BetterOtherRoles.Janitor.color, "Work with the <color=#FF1919FF>Mafia</color> by hiding dead bodies", "Hide dead bodies", RoleId.Janitor);
        ...
        public static RoleInfo detective = new RoleInfo("Detective", BetterOtherRoles.Detective.color, "Find the <color=#FF1919FF>Impostors</color> by examining footprints", "Examine footprints", RoleId.Detective);
        ...
        public static List<RoleInfo> getRoleInfoForPlayer(PlayerControl p, bool showModifier = true) {
            ...
            // Special roles
            if (p == BetterOtherRoles.Jester.jester) infos.Add(jester);
            if (p == BetterOtherRoles.Mayor.mayor) infos.Add(mayor);
            if (p == BetterOtherRoles.Portalmaker.portalmaker) infos.Add(portalmaker);
            if (p == BetterOtherRoles.Engineer.engineer) infos.Add(engineer);
            if (p == BetterOtherRoles.Sheriff.sheriff || p == BetterOtherRoles.Sheriff.formerSheriff) infos.Add(sheriff);
            if (p == BetterOtherRoles.Deputy.deputy) infos.Add(deputy);
            if (p == BetterOtherRoles.Lighter.lighter) infos.Add(lighter);
            if (p == BetterOtherRoles.Godfather.godfather) infos.Add(godfather);
            if (p == BetterOtherRoles.Mafioso.mafioso) infos.Add(mafioso);
            if (p == BetterOtherRoles.Janitor.janitor) infos.Add(janitor);
            ...
            if (p == BetterOtherRoles.Detective.detective) infos.Add(detective);
        ...
        public static String GetRolesString(PlayerControl p, bool useColors, bool showModifier = true, bool suppressGhostInfo = false) {
            ...
            if (!suppressGhostInfo && p != null) {
                ...
                if (Helpers.shouldShowGhostInfo()) {
                    ...
                    if (BetterOtherRoles.Deputy.handcuffedPlayers.Contains(p.PlayerId))
                        roleName = Helpers.cs(Color.gray, "(cuffed) ") + roleName;
                    if (BetterOtherRoles.Deputy.handcuffedKnows.ContainsKey(p.PlayerId))  // Active cuff
                        roleName = Helpers.cs(BetterOtherRoles.Deputy.color, "(cuffed) ") + roleName;
