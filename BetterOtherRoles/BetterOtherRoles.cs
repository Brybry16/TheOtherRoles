...
namespace BetterOtherRoles
{
    ...
    public static class Medium {
        ...
        public static string getInfo(PlayerControl target, PlayerControl killer) {
            ...
            // suicides:
            if (killer == target) {
                if (target == BetterOtherRoles.Sheriff.sheriff || target == BetterOtherRoles.Sheriff.formerSheriff) infos.Add(SpecialMediumInfo.SheriffSuicide);
    ...
    public static class Shifter {
        ...
        public static void shiftRole (PlayerControl player1, PlayerControl player2, bool repeat = true) {
            if (BetterOtherRoles.Mayor.mayor != null && BetterOtherRoles.Mayor.mayor == player2) {
                if (repeat) shiftRole(player2, player1, false);
                BetterOtherRoles.Mayor.mayor = player1;
            } else if (BetterOtherRoles.Portalmaker.portalmaker != null && BetterOtherRoles.Portalmaker.portalmaker == player2) {
                if (repeat) shiftRole(player2, player1, false);
                BetterOtherRoles.Portalmaker.portalmaker = player1;
            } else if (BetterOtherRoles.Engineer.engineer != null && BetterOtherRoles.Engineer.engineer == player2) {
                if (repeat) shiftRole(player2, player1, false);
                BetterOtherRoles.Engineer.engineer = player1;
            } else if (BetterOtherRoles.Sheriff.sheriff != null && BetterOtherRoles.Sheriff.sheriff == player2) {
                if (repeat) shiftRole(player2, player1, false);
                if (BetterOtherRoles.Sheriff.formerDeputy != null && BetterOtherRoles.Sheriff.formerDeputy == BetterOtherRoles.Sheriff.sheriff) BetterOtherRoles.Sheriff.formerDeputy = player1;  // Shifter also shifts info on promoted deputy (to get handcuffs)
                BetterOtherRoles.Sheriff.sheriff = player1;
            } else if (BetterOtherRoles.Deputy.deputy != null && BetterOtherRoles.Deputy.deputy == player2) {
                if (repeat) shiftRole(player2, player1, false);
                BetterOtherRoles.Deputy.deputy = player1;
            } else if (BetterOtherRoles.Lighter.lighter != null && BetterOtherRoles.Lighter.lighter == player2) {
                if (repeat) shiftRole(player2, player1, false);
                BetterOtherRoles.Lighter.lighter = player1;
            } else if (BetterOtherRoles.Detective.detective != null && BetterOtherRoles.Detective.detective == player2) {
                if (repeat) shiftRole(player2, player1, false);
                BetterOtherRoles.Detective.detective = player1;
