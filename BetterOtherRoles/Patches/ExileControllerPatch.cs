...
namespace BetterOtherRoles.Patches {
    ...
    class ExileControllerWrapUpPatch {
        ...
        static void WrapUpPostfix(GameData.PlayerInfo exiled) {
            ...
            else if (exiled != null && BetterOtherRoles.Jester.jester != null && BetterOtherRoles.Jester.jester.PlayerId == exiled.PlayerId) {
                BetterOtherRoles.Jester.triggerJesterWin = true;
            }
            ...
            if (BetterOtherRoles.Deputy.deputy != null)
            {
            ...
            try {
                if (ExileController.Instance != null && ExileController.Instance.exiled != null) {
                    ...
                    if (id == StringNames.ImpostorsRemainP || id == StringNames.ImpostorsRemainS) {
                        if (BetterOtherRoles.Jester.jester != null && player.PlayerId == BetterOtherRoles.Jester.jester.PlayerId) __result = "";
                    }
