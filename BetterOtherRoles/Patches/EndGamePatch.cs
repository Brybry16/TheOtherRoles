...
namespace BetterOtherRoles.Patches {
    ...
    public class OnGameEndPatch {
        ...
        public static void Postfix(AmongUsClient __instance, [HarmonyArgument(0)]ref EndGameResult endGameResult) {
            ...
            if (BetterOtherRoles.Jester.jester != null) notWinners.Add(BetterOtherRoles.Jester.jester);
            ...
            bool jesterWin = BetterOtherRoles.Jester.jester != null && gameOverReason == (GameOverReason)CustomGameOverReason.JesterWin;
            ...
            // Jester win
                ...
                TempData.winners = new Il2CppSystem.Collections.Generic.List<WinningPlayerData>();
                WinningPlayerData wpd = new WinningPlayerData(BetterOtherRoles.Jester.jester.Data);
                TempData.winners.Add(wpd);
                ...
                if (!Lovers.existingWithKiller()) {
                    ...
                    foreach (PlayerControl p in CachedPlayer.AllPlayers) {
                        ...
                        if (p == Lovers.lover1 || p == Lovers.lover2)
                            ...
                            TempData.winners.Add(new WinningPlayerData(p.Data));
                        else if (p != BetterOtherRoles.Jester.jester && p != Jackal.jackal && p != Sidekick.sidekick && p != Arsonist.arsonist && p != Vulture.vulture && !Jackal.formerJackals.Contains(p) && !p.Data.Role.IsImpostor)
                            TempData.winners.Add(new WinningPlayerData(p.Data));
                    }
                }
                // Lovers solo win
            ...
            if (Lawyer.lawyer != null && Lawyer.target != null && (!Lawyer.target.Data.IsDead || Lawyer.target == BetterOtherRoles.Jester.jester) && !Pursuer.notAckedExiled && !Lawyer.isProsecutor) {
    ...
    public class EndGameManagerSetUpPatch {
        public static void Postfix(EndGameManager __instance) {
            ...
            if (AdditionalTempData.winCondition == WinCondition.JesterWin) {
                ...
                textRenderer.color = BetterOtherRoles.Jester.color;
            }
    ...
    class CheckEndCriteriaPatch {
        ...
        private static bool CheckAndEndGameForJesterWin(ShipStatus __instance) {
            if (BetterOtherRoles.Jester.triggerJesterWin) {
                //__instance.enabled = false;
