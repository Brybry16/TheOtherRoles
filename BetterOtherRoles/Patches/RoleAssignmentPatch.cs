...
namespace BetterOtherRoles.Patches {
    ...
    class RoleManagerSelectRolesPatch {
        ...
        private static void assignDependentRoles(RoleAssignmentData data) {
            ...
            if (isSheriff && BetterOtherRoles.Sheriff.sheriff == null && data.crewmates.Count > 0 && data.maxCrewmateRoles > 0 && sheriffFlag) { // Set Sheriff cause he won the lottery
            ...
            if (BetterOtherRoles.Sheriff.sheriff != null) { // Deputy
            ...
            if (Lawyer.lawyer != null) {
                ...
                if (!Lawyer.isProsecutor) { // Lawyer
                    foreach (PlayerControl p in CachedPlayer.AllPlayers) {
                        if (!p.Data.IsDead && !p.Data.Disconnected && p != Lovers.lover1 && p != Lovers.lover2 && (p.Data.Role.IsImpostor || p == Jackal.jackal || (Lawyer.targetCanBeJester && p == BetterOtherRoles.Jester.jester)))
