...
namespace BetterOtherRoles.Patches {
    ...
    public class ShipStatusPatch 
    {
        ...
        public static bool Prefix(ref float __result, ShipStatus __instance, [HarmonyArgument(0)] GameData.PlayerInfo player) {
            ...
            if (BetterOtherRoles.Lighter.lighter != null && BetterOtherRoles.Lighter.lighter.PlayerId == player.PlayerId) {
                ...
                __result = Mathf.Lerp(__instance.MaxLightRadius * BetterOtherRoles.Lighter.lighterModeLightsOffVision, __instance.MaxLightRadius * BetterOtherRoles.Lighter.lighterModeLightsOnVision, unlerped);
            }
