...
namespace BetterOtherRoles.Patches {
    ...
    class VentButtonDoClickPatch {
        static  bool Prefix(VentButton __instance) {
		    ...
		    if (__instance.currentTarget != null && !BetterOtherRoles.Deputy.handcuffedKnows.ContainsKey(CachedPlayer.LocalPlayer.PlayerId)) __instance.currentTarget.Use();
            return false;
        }
    }
    ...
    public static class VentUsePatch {
        public static bool Prefix(Vent __instance) {
            ...
            if (BetterOtherRoles.Deputy.handcuffedPlayers.Contains(CachedPlayer.LocalPlayer.PlayerId)) {
                BetterOtherRoles.Deputy.setHandcuffedKnows();
                return false;
            }
    ...
    class SabotageButtonRefreshPatch {
        static void Postfix() {
            ...
            bool blockSabotageJanitor = (BetterOtherRoles.Janitor.janitor != null && BetterOtherRoles.Janitor.janitor == CachedPlayer.LocalPlayer.PlayerControl);
            bool blockSabotageMafioso = (BetterOtherRoles.Mafioso.mafioso != null && BetterOtherRoles.Mafioso.mafioso == CachedPlayer.LocalPlayer.PlayerControl && BetterOtherRoles.Godfather.godfather != null && !BetterOtherRoles.Godfather.godfather.Data.IsDead);
    ...
    class ReportButtonDoClickPatch {
        public static bool Prefix(ReportButton __instance) {
            if (__instance.isActiveAndEnabled && BetterOtherRoles.Deputy.handcuffedPlayers.Contains(CachedPlayer.LocalPlayer.PlayerId) && __instance.graphic.color == Palette.EnabledColor) BetterOtherRoles.Deputy.setHandcuffedKnows();
            return !BetterOtherRoles.Deputy.handcuffedKnows.ContainsKey(CachedPlayer.LocalPlayer.PlayerId);
        }
    }
    ...
    class EmergencyMinigameUpdatePatch {
        static void Postfix(EmergencyMinigame __instance) {
            ...
            if (BetterOtherRoles.Jester.jester != null && BetterOtherRoles.Jester.jester == CachedPlayer.LocalPlayer.PlayerControl && !BetterOtherRoles.Jester.canCallEmergency) {
                roleCanCallEmergency = false;
            ...
            if (__instance.state == 1) {
                ...
                int remaining = Mathf.Min(localRemaining, (BetterOtherRoles.Mayor.mayor != null && BetterOtherRoles.Mayor.mayor == CachedPlayer.LocalPlayer.PlayerControl) ? 1 : teamRemaining);
