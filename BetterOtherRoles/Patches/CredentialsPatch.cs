...
$@"<size=130%><color=#ff351f>BetterOtherRoles</color></size> v{TheOtherRolesPlugin.Version.ToString() + (TheOtherRolesPlugin.betaDays>0 ? "-BETA": "")}";
...
$@"<size=60%> <color=#FCCE03FF>Special thanks to Smeggy</color></size>";
        ...
        internal static class PingTrackerPatch
        {
            ...
            static void Postfix(PingTracker __instance){
                ...
                if (AmongUsClient.Instance.GameState == InnerNet.InnerNetClient.GameStates.Started) {
                    ...
                    __instance.text.text = $"<size=130%><color=#ff351f>BetterOtherRoles</color></size> v{TheOtherRolesPlugin.Version.ToString() + (TheOtherRolesPlugin.betaDays > 0 ? "-BETA" : "")}\n{gameModeText}" + __instance.text.text;
        ...
        public static class LogoPatch
        {
            ...
            static void Postfix(PingTracker __instance) {
                ...
                loadSprites();
                renderer.sprite = Helpers.loadSpriteFromResources("BetterOtherRoles.Resources.Banner.png", 300f);
            ...
            public static void loadSprites() {
                if (bannerSprite == null) bannerSprite = Helpers.loadSpriteFromResources("BetterOtherRoles.Resources.Banner.png", 300f);
                if (banner2Sprite == null) banner2Sprite = Helpers.loadSpriteFromResources("BetterOtherRoles.Resources.Banner2.png", 300f);
                if (horseBannerSprite == null) horseBannerSprite = Helpers.loadSpriteFromResources("BetterOtherRoles.Resources.bannerTheHorseRoles.png", 300f);
            }
