...
namespace BetterOtherRoles
{
    ...
    public static void HandleShareOptions(byte numberOfOptions, MessageReader reader) {            
        ...
        public static void setRole(byte roleId, byte playerId) {
            foreach (PlayerControl player in CachedPlayer.AllPlayers) {
                if (player.PlayerId == playerId) {
                    ...
                    case RoleId.Jester:
                        BetterOtherRoles.Jester.jester = player;
                        break;
                    case RoleId.Mayor:
                        BetterOtherRoles.Mayor.mayor = player;
                        break;
                    case RoleId.Portalmaker:
                        BetterOtherRoles.Portalmaker.portalmaker = player;
                        break;
                        case RoleId.Engineer:
                        BetterOtherRoles.Engineer.engineer = player;
                        break;
                    case RoleId.Sheriff:
                        BetterOtherRoles.Sheriff.sheriff = player;
                        break;
                    case RoleId.Deputy:
                        BetterOtherRoles.Deputy.deputy = player;
                        break;
                    case RoleId.Lighter:
                        BetterOtherRoles.Lighter.lighter = player;
                        break;
                    case RoleId.Godfather:
                        BetterOtherRoles.Godfather.godfather = player;
                        break;
                    case RoleId.Mafioso:
                        BetterOtherRoles.Mafioso.mafioso = player;
                        break;
                    case RoleId.Janitor:
                        BetterOtherRoles.Janitor.janitor = player;
                        break;
                    case RoleId.Detective:
                        BetterOtherRoles.Detective.detective = player;
                        break;
        ...
        public static void engineerUsedRepair() {
            BetterOtherRoles.Engineer.remainingFixes--;
            if (Helpers.shouldShowGhostInfo()) {
                Helpers.showFlash(BetterOtherRoles.Engineer.color, 0.5f, "Engineer Fix"); ;
            }
        }
        ...
        {
            BetterOtherRoles.Deputy.remainingHandcuffs--;
            BetterOtherRoles.Deputy.handcuffedPlayers.Add(targetId);
        }

        public static void deputyPromotes()
        {
            if (BetterOtherRoles.Deputy.deputy != null) {  // Deputy should never be null here, but there appeared to be a race condition during testing, which was removed.
                BetterOtherRoles.Sheriff.replaceCurrentSheriff(BetterOtherRoles.Deputy.deputy);
                BetterOtherRoles.Sheriff.formerDeputy = BetterOtherRoles.Deputy.deputy;
                BetterOtherRoles.Deputy.deputy = null;
        ...
        public static void erasePlayerRoles(byte playerId, bool ignoreModifier = true) {
            ...
            // Crewmate roles
            if (player == BetterOtherRoles.Mayor.mayor) BetterOtherRoles.Mayor.clearAndReload();
            if (player == BetterOtherRoles.Portalmaker.portalmaker) BetterOtherRoles.Portalmaker.clearAndReload();
            if (player == BetterOtherRoles.Engineer.engineer) BetterOtherRoles.Engineer.clearAndReload();
            if (player == BetterOtherRoles.Sheriff.sheriff) BetterOtherRoles.Sheriff.clearAndReload();
            if (player == BetterOtherRoles.Deputy.deputy) BetterOtherRoles.Deputy.clearAndReload();
            if (player == BetterOtherRoles.Lighter.lighter) BetterOtherRoles.Lighter.clearAndReload();
            if (player == BetterOtherRoles.Detective.detective) BetterOtherRoles.Detective.clearAndReload();
            ...
            if (player == BetterOtherRoles.Godfather.godfather) BetterOtherRoles.Godfather.clearAndReload();
            if (player == BetterOtherRoles.Mafioso.mafioso) BetterOtherRoles.Mafioso.clearAndReload();
            if (player == BetterOtherRoles.Janitor.janitor) BetterOtherRoles.Janitor.clearAndReload();
            ...
            // Other roles
            if (player == BetterOtherRoles.Jester.jester) BetterOtherRoles.Jester.clearAndReload();
        ...
        public static void thiefStealsRole(byte playerId) {
            ...
            if (target == null) return;
            if (target == BetterOtherRoles.Sheriff.sheriff) BetterOtherRoles.Sheriff.sheriff = thief;
            ...
            if (target == BetterOtherRoles.Godfather.godfather) BetterOtherRoles.Godfather.godfather = thief;
            if (target == BetterOtherRoles.Mafioso.mafioso) BetterOtherRoles.Mafioso.mafioso = thief;
            if (target == BetterOtherRoles.Janitor.janitor) BetterOtherRoles.Janitor.janitor = thief;
        ...
        public static void receiveGhostInfo (byte senderId, MessageReader reader) {
            ...
            switch (infoType) {
                case GhostInfoTypes.HandcuffNoticed:
                    BetterOtherRoles.Deputy.setHandcuffedKnows(true, senderId);
                    break;
                case GhostInfoTypes.HandcuffOver:
                    _ = BetterOtherRoles.Deputy.handcuffedKnows.Remove(senderId);
                    break;
        ...
        static void Postfix([HarmonyArgument(0)]byte callId, [HarmonyArgument(1)]MessageReader reader)
        {
            ...
            switch (packetId) {
                ...
                case (byte)CustomRPC.MayorSetVoteTwice:
                    BetterOtherRoles.Mayor.voteTwice = reader.ReadBoolean();
                    break;
