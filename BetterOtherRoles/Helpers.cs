...
namespace BetterOtherRoles {
    ...
    public static class Helpers
    {
        ...
        public static bool hasFakeTasks(this PlayerControl player) {
            return (player == BetterOtherRoles.Jester.jester || player == Jackal.jackal || player == Sidekick.sidekick || player == Arsonist.arsonist || player == Vulture.vulture || Jackal.formerJackals.Any(x => x == player));
        }
        ...
        public static bool hidePlayerName(PlayerControl source, PlayerControl target) {
            ...
            else if (BetterOtherRoles.Deputy.knowsSheriff && (source == BetterOtherRoles.Sheriff.sheriff || source == BetterOtherRoles.Deputy.deputy) && (target == BetterOtherRoles.Sheriff.sheriff || target == BetterOtherRoles.Deputy.deputy)) return false; // Sheriff & Deputy see the names of each other
            return true;
        }
        ...
        public static bool roleCanUseVents(this PlayerControl player) {
            ...
            if (BetterOtherRoles.Engineer.engineer != null && BetterOtherRoles.Engineer.engineer == player)
                roleCouldUse = true;
                ...
                if (BetterOtherRoles.Janitor.janitor != null && BetterOtherRoles.Janitor.janitor == CachedPlayer.LocalPlayer.PlayerControl)
                    roleCouldUse = false;
        ...
        public static bool isKiller(PlayerControl player) {
            return player.Data.Role.IsImpostor || 
                (isNeutral(player) && 
                player != BetterOtherRoles.Jester.jester && 
        ...
        public static bool hasImpVision(GameData.PlayerInfo player) {
            return player.Role.IsImpostor
                ...
                || (BetterOtherRoles.Jester.jester != null && BetterOtherRoles.Jester.jester.PlayerId == player.PlayerId && BetterOtherRoles.Jester.hasImpostorVision)
